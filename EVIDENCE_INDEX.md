...
| The typed shallow max-affine engine reproduces both independently audited continuous three-agent formulas at every arrangement vertex | `PHASE_IV_AUDIT_CENSUS_PREREGISTRATION.md`, `src/mechanism_discovery/piecewise_affine.py`, `src/mechanism_discovery/max_affine_corpus.py`, `scripts/run_max_affine_certification.py`, `artifacts/max_affine_certification.json` | SUPPORTED for the stated expression language and ordered unit cube; not a general neural-network-verification claim |
